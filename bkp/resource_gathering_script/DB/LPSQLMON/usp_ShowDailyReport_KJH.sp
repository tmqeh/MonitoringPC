...
*******************************************************************************************/
CREATE PROC [dbo].[usp_ShowDailyReport_KJH] 
	@in_DATE		VARCHAR(8) = ''
AS
BEGIN
	...
	BEGIN
		...
		WHERE INP_DTM BETWEEN CONVERT(VARCHAR(10), CONVERT(DATE, @in_DATE), 121) AND CONVERT(VARCHAR(10), CONVERT(DATE, @in_DATE), 121) + ' 09:59:59.997'
